	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Tests" Type="Folder">
			...
			<Item Name="Test Utilities" Type="Folder">
				<Item Name="Test VI Source Separated.vi" Type="VI" URL="../../tests/Test Utilities/Test VI Source Separated.vi"/>
		...
		<Item Name="State Machine Support API" Type="Folder">
			<Item Name="vendored" Type="Folder">
				<Item Name="Periodic Trigger__ogtk__JKI-SM.vi" Type="VI" URL="../State Machine Support API/vendored/Periodic Trigger__ogtk__JKI-SM.vi"/>
			</Item>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="vi.lib" Type="Folder">
				...
				<Item Name="Select State(s)__JKI_lib_State_Machine.vim" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI Toolkits/State Machine/_JKI_lib_State_Machine.llb/Select State(s)__JKI_lib_State_Machine.vim"/>
